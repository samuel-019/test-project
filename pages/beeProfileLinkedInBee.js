var linkedInBee = {
  ...
  pageURL: function () {
    this.verify.urlContains('/bee/xcoobee_linkedin_free')
  },

  costDetails: function () {
    this.verify.containsText('@beeCost', 'Bee Cost:  2')
    this.verify.containsText('@beeCostType', 'Cost Type: Per file')
    this.verify.containsText('@beeFileAllowed', 'jpeg, jpg, png, gif')
    this.clickAddlInfo()
    this.verify.containsText('@addlInfo1', 'xcoobee_linkedin_free')
  ...
  titleToolTip: function () {
    this.moveToElement('@beeTitle2', 0, 0, function () {
      ...
      return this.getAttribute('.panel-body >.row >div:nth-child(1) a', 'aria-describedby', function (result) {
        this.verify.equal(result.value, 'The LinkedIn bee will help you post messages to your liked in feed. If you submit images for your posts they will optionally go through imgur integrations if you have it enabled. Please use the Social Bee if you need automated watermarking to ensure you are protecting your copyrights.')
      })
    })
  },
  ...
  beeContent: function () {
    ...
    this.verify.containsText('@beeTitle', 'Share on LinkedIn')
    return this.verify.containsText('@beeDescription', 'The LinkedIn bee will help you post messages to your liked in feed. If you submit images for your posts they will optionally go through imgur integrations if you have it enabled. Please use the Social Bee if you need automated watermarking to ensure you are protecting your copyrights.')
  },
...
module.exports = {
  commands: [linkedInBee],

  url: function () {
    this.api.maximizeWindow()
    return this.api.launchUrl + 'bee/xcoobee_linkedin_free'
  },
