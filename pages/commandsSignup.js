var signuptest = {
  ...
  verifySignupPage: function () {
    this.waitForElementVisible('@closeIcon', 10000)
      ...
      .verify.visible('@registerButton')
      .verify.visible('@privacyPolicyLink')
    return this.verify.visible('@signupAlertMessage')
  },
  ...
  setFirstname: function (firstname) {
    return this.waitForElementVisible('@firstName', 5000)
  ...
  globalValidationmessage: function (errorMessage) {
    return this.waitForElementVisible('@globalErrorcontainer', 5000)
      .verify.containsText('@globalErrorcontainer', errorMessage)
  },

  /** Function to verify if register button is enabled */
  verifyRegisterIfEnabled: function () {
    return this.waitForElementVisible('@registerButton', 5000)
      .expect.element('@registerButton').to.not.be.enabled
  },
  ...
  verifyEmailVerificationpage: function () {
    return this.waitForElementVisible('@verificationStageBanner', 10000)
      .verify.visible('@xcoobeeLogo')
...
module.exports = {
  ...
  elements: {
    ...
    useDifferentaccountButton: '.pull-right', // css selector for use different account button
